      ...
      <div className="border-t border-white/20 pt-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6  pb-6">
          ...
          <nav className="flex gap-6 text-sm opacity-90">
            ...
            <Link href="/career" className="hover:opacity-75">
              Careers
            </Link>
            ...
            <a href="/get-in-touch" className="hover:opacity-75">
              Contact Us
            </a>
          </nav>
        </div>
        ...
        <div className="border-t border-white/20 pt-6 flex flex-col md:flex-row justify-between items-start md:items-center">
          ...
          {/* Center - Privacy & Terms (added here) */}
          <div className="flex gap-6 text-xs opacity-85 mt-4 md:mt-0">
            <a href="/privacy-policy" className="hover:opacity-75">
              Privacy Policy
            </a>
            <a href="/terms-and-conditions" className="hover:opacity-75">
              Terms & Conditions
            </a>
          </div>
          ...
          <div className="flex gap-5 mt-4 md:mt-0 z-50">
            ...
            >
              <Youtube
                size={16}
                className="opacity-90 hover:opacity-75 mt-px"
              />
            </a>
          </div>
        </div>
