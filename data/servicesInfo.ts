  ...
  },
  {
    ...
    packages: [
      ...
      },
      {
        ...
        packageDesc:
          "Advanced automation with NLP, analytics & smart pipelines",
        price: "₹80K – ₹3L",
      },
      {
  ...
  },
  {
    ...
    packages: [
      ...
      },
      {
        ...
        packageDesc:
          "Animated text, transitions, infographics, visual overlays",
        price: "₹1L – ₹3L",
      },
      {
    ...
    packages: [
      {
        ...
        packageDesc:
          "Manual testing for small apps, bug reporting, UI/UX checks",
        price: "₹8K – ₹40K",
      },
      {
      ...
      },
      {
        ...
        packageDesc:
          "Automated test scripts, regression testing, CI integration",
        price: "₹1.5L – ₹5L",
      },
      {
